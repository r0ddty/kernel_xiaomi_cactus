...
# Kernel base version
KERNEL_BASE_VERSION = 4.9-200

# The kernel cmdline to use
KERNEL_BOOTIMAGE_CMDLINE = bootopt=64S3,32N2,64N2 androidboot.selinux=permissive buildvariant=userdebug datapart=/dev/mmcblk1p1
...
DEVICE_FULL_NAME = Xiaomi Redmi 6A
...
KERNEL_BOOTIMAGE_DTB_OFFSET = 0x0000000047880000
...
DEB_TOOLCHAIN = clang-android-10.0-r370808, linux-initramfs-halium-generic:arm64, binutils-aarch64-linux-gnu, clang-android-6.0-4691093, gcc-4.9-aarch64-linux-android, g++-4.9-aarch64-linux-android, libgcc-4.9-dev-aarch64-linux-android-cross
